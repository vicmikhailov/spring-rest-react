...
/**
 * ChartConfig: A type-safe configuration object (like a Map<String, DTO>).
 * Each key represents a data series (e.g., "sales", "revenue"), and the value
 * defines its label, icon, and color.
 */
...
/**
 * getPayloadConfigFromPayload: A "Lookup Strategy".
 * Since recharts provides a generic "payload" object, this function
 * maps it back to our type-safe ChartConfig.
 * Analogy: Like a Map.getOrDefault() with extra logic for nested properties.
 */
